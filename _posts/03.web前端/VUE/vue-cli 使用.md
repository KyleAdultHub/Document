...
转载自: https://www.cnblogs.com/m18320364494/p/9560522.html
...
3、npm run dev 开发模式下运行我们的程序（实际上是执行了package.json 中的script脚本）。给我们自动构建了开发用的服务器环境和在浏览器中打开，并实时监视我们的代码更改，即时呈现给我们。
...
引文在app.vue中我们看到了路由文件，虽然router的内容比较多，但是我们先简单的看一下。
