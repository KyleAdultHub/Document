---
title: Flink(Source-KafkaSink-Mysql)
...
public class MysqlSinkTest {
    ...
    DataStream<Tuple3<Integer, String, Integer>> sourceStream = stream.filter((FilterFunction<String>) value -> 			StringUtils.isNotBlank(value)).map((MapFunction<String, Tuple3<Integer, String, Integer>>) value -> {
